...
---------------------- INPUT FILES ---------------------------------------------
wind_90m_4.03mps__0.dat    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../inflowwind_file/90m_4.03mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
