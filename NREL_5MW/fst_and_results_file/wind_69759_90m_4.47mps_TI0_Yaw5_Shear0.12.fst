...
---------------------- INPUT FILES ---------------------------------------------
wind_90m_4.47mps__5.dat    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../inflowwind_file/90m_4.47mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
